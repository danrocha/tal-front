<template>
  <div class="pt-8 container mx-auto md:w-auto md:mr-6 md:ml-56">
    ...
    <p>
      ...
      continue to use The Architecture List's website if you do not accept all of the terms and
    ...
    <p>
      ...
      prevailing law of Germany. Any use of the above terminology or other words in the singular,
      plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as
      referring to same.
    </p>
    <h3>Cookies</h3>
    <p>
      We employ the use of cookies. By using The Architecture List's website you consent to the use
      of cookies in accordance with The Architecture List’s privacy policy.
    </p>
    <p>
      Most of the modern day interactive web sites use cookies to enable us to retrieve user details
      for each visit. Cookies are used in some areas of our site to enable the functionality of this
      area and ease of use for those people visiting. Some of our affiliate / advertising partners
      may also use cookies.
    </p>
    <h3>License</h3>
    <p>
      Unless otherwise stated, The Architecture List and/or it’s licensors own the intellectual
      property rights for all material on The Architecture List. All intellectual property rights
      are reserved. You may view and/or print pages from http://thearchitecturelist.com for your own
      personal use subject to restrictions set in these terms and conditions.
    </p>
    <p>You must not:</p>
    <ol>
      <li>Republish material from http://thearchitecturelist.com</li>
      <li>Sell, rent or sub-license material from http://thearchitecturelist.com</li>
      <li>Reproduce, duplicate or copy material from http://thearchitecturelist.com</li>
    </ol>
    <p>
      Redistribute content from The Architecture List (unless content is specifically made for
      redistribution).
    </p>
    <h3>User Comments</h3>
    <ol>
      ...
      <li>
        ...
        information, material and data ('Comments') in areas of the website. The Architecture List
        does not screen, edit, publish or review Comments prior to their appearance on the website
        and Comments do not reflect the views or opinions ofThe Architecture List, its agents or
        affiliates. Comments reflect the view and opinion of the person who posts such view or
        opinion. To the extent permitted by applicable laws The Architecture Listshall not be
        responsible or liable for the Comments or for any loss cost, liability, damages or expenses
        caused and or suffered as a result of any use of and/or posting of and/or appearance of the
        Comments on this website.
      </li>
      <li>
        The Architecture Listreserves the right to monitor all Comments and to remove any Comments
        which it considers in its absolute discretion to be inappropriate, offensive or otherwise in
    ...
    <p>
      ...
      work-at-home opportunities, shall not be allowed to link); (b)the organization does not have
      an unsatisfactory record with us; (c) the benefit to us from the visibility associated with
      the hyperlink outweighs the absence of
      <?=$companyName?>; and (d) where the link is in the context of general resource information or
      is otherwise consistent with editorial content in a newsletter or similar product furthering
      the mission of the organization.
    </p>

    <p>
      These organizations may link to our home page, to publications or to other Web site
      information so long as the link: (a) is not in any way misleading; (b) does not falsely imply
      sponsorship, endorsement or approval of the linking party and it products or services; and (c)
    ...
    <p>
      No use of The Architecture List’s logo or other artwork will be allowed for linking absent a
      trademark license agreement.
    </p>
    <h3>Iframes</h3>
    <p>
      Without prior approval and express written permission, you may not create frames around our
      Web pages or use other techniques that alter in any way the visual presentation or appearance
      of our Web site.
    </p>
    ...
    <p>
      ...
      its linking policy at any time. By continuing to link to our Web site, you agree to be bound
    ...
    <p>
      ...
      purpose and/or the use of reasonable care and skill). Nothing in this disclaimer will:
    </p>
    <ol>
      <li>
